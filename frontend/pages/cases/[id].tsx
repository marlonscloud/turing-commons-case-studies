      ...
      <div className="min-h-full">
        ...
        <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
            <p className='text-xs tracking-widest uppercase mb-1'>Editing</p>
            <h1 className="text-2xl font-normal tracking-tight text-gray-900"><span>{caseStudy.heading}</span></h1>
          </div>
        </header>
        <main>
